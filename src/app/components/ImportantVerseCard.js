...
export default function ImportantVerseCard({ item, index }) {
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-orange-200 hover:border-orange-300 transition-all duration-300 hover:shadow-2xl">
      {/* Verse Header */}
      <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white p-6">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-orange-100 text-lg">{item.chapter.meaning}</p>
          </div>
          <div className="text-right ml-4">
            ...
            <p className="text-sm text-orange-100 font-semibold">Important Verse</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-100">
              <h5 className="font-semibold text-gray-700 mb-2 text-sm">Transliteration:</h5>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
              <h5 className="font-semibold text-gray-700 mb-2 text-sm">Word Meanings:</h5>
              <p className="text-sm text-gray-700 leading-relaxed">
